...
import { GET_REFERRER } from "../../../queries/user.query";
...
const YourReferral = () => {
    ...
    return (
        <>
            ...
            <LoadingIcon className="text-theme-1" loading={loading || _loading} />
            ...
            {user && (
                <div className="my-4 intro-y flex items-center box px-4 py-8">
                    ...
                    <span className="text-teal-600 font-semibold">Referrer</span>
                </div>
            )}
        </>
    );
